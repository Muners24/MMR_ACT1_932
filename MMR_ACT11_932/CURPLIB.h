...
void curpGen(char namem[],char appatm[],char apmatm[],char anio[],char mes[],char dia[],char estado[],char curp[],char sex);
...
void curpGen(char namem[],char appatm[],char apmatm[],char anio[],char mes[],char dia[],char estado[],char curp[],char sex)
{
    //datos
    char rnd[2];
    char name[LN],appat[L],apmat[L];
    strcopy(name,namem);
    strcopy(appat,appatm);
    strcopy(apmat,apmatm);
